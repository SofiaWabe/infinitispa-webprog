...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <br>
      <ol class="breadcrumb">
         <li><a href="{{ route('appointment.index') }}"><i class="fa fa-calendar-check-o"></i> Appointment </a></li>
                    ...
                    <tbody>
                      @foreach ($reservations as $reservation)
                        <tr role="row" class="odd">
                            ...
                            <td class="hidden-xs">
                                <ul>
                                  @foreach($therapists as $therapist)
                                    @if($reservation->id === $therapist->reservation_id)
                            ...
                            <td>
                              <form class="row" method="POST" action="{{ route('appointment.destroy', ['id' => $reservation->id]) }}" onsubmit = "return confirm('Are you sure?')">
                                  <input type="hidden" name="_method" value="DELETE">
                                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                  <a href="{{ route('appointment.edit', ['id' => $reservation->id]) }}" class="btn btn-warning btn-sm edit" data-toggle="tooltip" title="" data-original-title="Assign Therapist and Room"><i class="fa fa-edit"></i></a>
