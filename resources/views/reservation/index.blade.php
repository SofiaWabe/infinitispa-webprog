                          ...
                          <tr role="row" class="odd">
                            ...
                            <td>
                              <form class="row" method="POST" action="{{ route('reservation.destroy', ['id' => $reservation->id]) }}" onsubmit = "return confirm('Are you sure?')">
                                  ...
                                  <a href="{{ route('reservation.edit', ['id' => $reservation->id]) }}" class="btn btn-warning btn-sm edit" data-toggle="tooltip" title="" data-original-title="Approve"><i class="fa fa-thumbs-up"></i></a>
                                  <button class="btn btn-danger btn-sm delReservation" data-toggle="tooltip" title="" data-original-title="Decline"><i class="fa fa-thumbs-down"></i></button>
                              </form>
                            </td>
                        </tr>
                      @endforeach
...
<script>
$('.btn btn-danger btn-sm delReservation').on('click', function(){
  alert($id);
})
</script>
</body>
